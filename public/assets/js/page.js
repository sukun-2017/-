...
//      fun(currentPage);
    ...
    "initPageEvent":function(listCount){
        $("#"+page.pageId +">li[qqconnect='pageItem']").on("click",function(){
    ...
    "getPageListModel":function(pageCount,currentPage){
        ...
        var appendStr ="";
        appendStr+="<li qqconnect='"+prePageClass+"' page-data='1' page-rel='firstpage'>首页</li>";
        appendStr+="<li qqconnect='"+prePageClass+"' page-data='"+prePage+"' page-rel='prepage'>&lt;上一页</li>";
        ...
        for(var i=0;i<showPageNum;i++){
            ...
            appendStr+="<li qqconnect='"+itemPageClass+"' page-data='"+pageNumber+"' page-rel='itempage'>"+pageNumber+"</li>";
        }
        appendStr+="<li qqconnect='"+nextPageClass+"' page-data='"+nextPage+"' page-rel='nextpage'>下一页&gt;</li>";
        appendStr+="<li qqconnect='"+nextPageClass+"' page-data='"+pageCount+"' page-rel='lastpage'>尾页</li>";
       return appendStr;
