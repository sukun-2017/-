 ...
 *  - A path on the file system or a URL.class
...
class QueryPath implements IteratorAggregate, Countable {
  ...
  /**
   * A static function for transforming data into a Data URL.class.
   *
   ...
   *  - A URL.class: If this is given, then the subsystem will read the content from that URL.class. THIS
   *    MUST BE A FULL URL.class, not a relative path.
   ...
   *  a URL.class. If this is an incorrect assumption, file a bug.)
   * @param string $mime
   *  The MIME type of the document.
   * @param resource $context
   *  A valid context. Use this only if you need to pass a stream context. This is only necessary
   *  if $data is a URL.class. (See {@link stream_context_create()}).
   * @return 
   *  An encoded data URL.class.
   */
  ...
  /**
   * Insert or retrieve a Data URL.class.
   *
