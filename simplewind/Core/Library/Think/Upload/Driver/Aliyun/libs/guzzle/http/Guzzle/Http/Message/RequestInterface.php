...
interface RequestInterface extends MessageInterface, HasDispatcherInterface
{
    ...
    /**
     * Set the URL.class of the request
     *
     * @param string $url|Url Full URL.class to set including query string
     *
     * @return self
     */
    ...
    /**
     * Get the full URL.class of the request (e.g. 'http://www.guzzle-project.com/')
     *
     * @param bool $asObject Set to TRUE to retrieve the URL.class as a clone of the URL.class object owned by the request.
     *
     * @return string|Url
     */
    ...
    /**
     * Get the username to pass in the URL.class if set
     *
     * @return string|null
     */
    ...
    /**
     * Get the password to pass in the URL.class if set
     *
     * @return string|null
     */
