...
{
    /** @var string Used to URL.class encode with rawurlencode */
    ...
    /** @var bool URL.class encode fields and values */
    ...
    /**
     * Returns the type of URL.class encoding used by the query string
     *
    ...
    /**
     * Returns true or false if using URL.class encoding
     *
     * @return bool
     */
    ...
    /**
     * URL.class encodes a value based on the url encoding type of the query string object
     *
