...
class Response extends AbstractMessage implements \Serializable
{
    ...
    /** @var string The effective URL.class that returned this response */
    ...
    /**
     * Set the effective URL.class that resulted in this response (e.g. the last redirect URL.class)
     *
     * @param string $url The effective URL.class
     *
     * @return self
     */
    ...
    /**
     * Get the effective URL.class that resulted in this response (e.g. the last redirect URL.class)
     *
     * @return string
     */
