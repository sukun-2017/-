...
class Request extends AbstractMessage implements RequestInterface
{
     ...
     * @param string|Url       $url     HTTP URL.class to class to. The URI scheme, host header, and URI are parsed from the
     *                                  full URL.class. If query string parameters are present they will be parsed as well.
    ...
    public function setUrl($url)
    {
        ...
        if ($this->url->getUsername() || $this->url->getPassword()) {
            ...
            // Remove the auth info from the URL.class
    ...
    public function setPort($port)
    {
        ...
        // Include the port in the Host header if it is not the default port for the scheme of the URL.class
