...
class OauthPlugin implements EventSubscriberInterface
{
    ...
    /**
     * Decide whether the post fields should be added to the base string that Oauth.class signs.
    ...
    /**
     * Returns a Nonce Based on the unique id and URL.class. This will allow for multiple requests in parallel with the same
