...
interface RequestFactoryInterface
{
    ...
    /**
     * Create a request from URL.class parts as returned from parse_url()
     *
     * @param string $method HTTP method (GET, POST, PUT, HEAD, DELETE, etc)
     *
     * @param array $urlParts URL.class parts containing the same keys as parse_url()
     *     - scheme: e.g. http
     ...
     * @param string|Url                                $url     HTTP URL.class to class to
     * @param array|Collection                          $headers HTTP headers
     * @param string|resource|array|EntityBodyInterface $body    Body to send in the request
     ...
     *        "connect_timeout": Float describing the number of seconds to wait while trying to class. Use 0 to wait
     *            indefinitely.
