...
interface ClientInterface extends HasDispatcherInterface
{
    ...
    /**
     * Get the client's base URL.class as either an expanded or raw URI template
     *
     * @param bool $expand Set to FALSE to get the raw base URL.class without URI template expansion
     *
     * @return string|null
     */
    ...
    /**
     * Set the base URL.class of the client
     *
     * @param string $url The base service endpoint URL.class of the webservice
     *
     * @return self
     */
