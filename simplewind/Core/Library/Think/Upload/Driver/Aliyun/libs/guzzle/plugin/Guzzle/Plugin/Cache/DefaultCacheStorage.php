...
class DefaultCacheStorage implements CacheStorageInterface
{
    ...
    /**
     * Hash a request URL.class into a string that returns cache metadata
     *
    ...
    {
        // Allow cache.key_filter to trim down the URL.class cache key by removing generate query string values (e.g. auth)
     ...
     *
     * @param string              $url  URL.class of the entry
