...
/**
 * URL.class parser interface
 */
interface UrlParserInterface
{
    /**
     * Parse a URL.class using special handling for a subset of UTF-8 characters in the query string if needed.
     *
     * @param string $url URL.class to parse
     *
