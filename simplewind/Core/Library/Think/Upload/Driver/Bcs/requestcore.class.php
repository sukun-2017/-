...
class BCS_RequestCore {
	 ...
	 *
	 * @param string $url (Optional) The URL.class to request or service endpoint to query.
	...
	/**
	 * Set the URL.class to make the request to.
	 *
	 * @param string $url (Required) The URL.class to make the request to.
	 * @return $this A reference to the current instance.
	 */
